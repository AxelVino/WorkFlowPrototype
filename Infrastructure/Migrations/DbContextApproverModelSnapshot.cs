...
{
    [DbContext(typeof(DbContextApprover))]
    partial class DbContextApproverModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApprovalRule", b =>
                {
                    b.HasOne("Domain.Entities.ApproverRole", "ApproverRoleObject")
                        .WithMany()
                        .HasForeignKey("ApproverRoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Area", "AreaObject")
                        .WithMany()
                        .HasForeignKey("Area")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.ProjectType", "ProjectTypeObject")
                        .WithMany()
                        .HasForeignKey("Type")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ApproverRoleObject");

                    b.Navigation("AreaObject");

                    b.Navigation("ProjectTypeObject");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProjectApprovalStep", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "UserObject")
                        .WithMany()
                        .HasForeignKey("ApproverUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.ProjectProposal", "ProjectProposalObject")
                        .WithMany()
                        .HasForeignKey("ProjectProposalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.ApprovalStatus", "ApprovalStatusObject")
                        .WithMany()
                        .HasForeignKey("Status")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ApprovalStatusObject");

                    b.Navigation("ApproverRoleObject");

                    b.Navigation("ProjectProposalObject");
